...
# Define a function to create the view node and establish relationships
def create_view_node_and_relationships():
    query = """
    ...
    """
    graph.run(relationships_query)

# Call the function to create the view node and relationships
create_view_node_and_relationships()

# Example query to retrieve data from the view
query_view = """
    MATCH (summary:Summary)-[:INCLUDES_PATIENT]->(patient:Patient)
    RETURN summary, patient
"""
result = graph.run(query_view)
